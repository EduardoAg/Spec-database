...
namespace Master_Database {
    ...
    public partial class UsuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuariosRow AddusuariosRow(string nombre, string password, int IDRole, bool activo, string Role) {
            ...
            public string Role {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Role\' in table \'usuarios\' is DBNull.", e);
                    }
                }
                set {
...
namespace Master_Database.UsuariosDataSetTableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [usuarios] WHERE (([IDUsuario] = @Original_IDUsuario) AND ([nombre] = @Original_nombre) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ([IDRole] = @Original_IDRole) AND ([activo] = @Original_activo))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [usuarios] ([nombre], [password], [IDRole], [activo]) VALUES (@nombre" +
                ", @password, @IDRole, @activo);\r\nSELECT IDUsuario, nombre, password, IDRole, act" +
                "ivo FROM usuarios WHERE (IDUsuario = SCOPE_IDENTITY()) ORDER BY nombre";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [usuarios] SET [nombre] = @nombre, [password] = @password, [IDRole] = @IDRole, [activo] = @activo WHERE (([IDUsuario] = @Original_IDUsuario) AND ([nombre] = @Original_nombre) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ([IDRole] = @Original_IDRole) AND ([activo] = @Original_activo));
SELECT IDUsuario, nombre, password, IDRole, activo FROM usuarios WHERE (IDUsuario = @IDUsuario) ORDER BY nombre";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDUsuario, nombre, password, IDRole, activo\r\nFROM     usuarios\r\nORDER BY n" +
                "ombre";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT usuarios.IDUsuario, usuarios.nombre, usuarios.password, usuarios.IDRole, u" +
                "suarios.activo, roles.nombre AS Role\r\nFROM     usuarios INNER JOIN\r\n            " +
                "      roles ON usuarios.IDRole = roles.IDRole";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT IDRole, IDUsuario, activo, nombre, password FROM usuarios WHERE (IDUsuario" +
                " = @IDUsuario)";
...
FROM     usuarios INNER JOIN
                  roles ON usuarios.IDRole = roles.IDRole INNER JOIN
                  rolesPermisos ON roles.IDRole = rolesPermisos.IDRole
WHERE  (usuarios.IDUsuario = @IDUsuario) AND (rolesPermisos.IDPermiso = @IDPermiso)";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IDPermiso", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "IDPermiso", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByConRole(UsuariosDataSet.usuariosDataTable dataTable) {
        ...
        public virtual UsuariosDataSet.usuariosDataTable GetDataByConRole() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            UsuariosDataSet.usuariosDataTable dataTable = new UsuariosDataSet.usuariosDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByIDUsuario(UsuariosDataSet.usuariosDataTable dataTable, int IDUsuario) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual UsuariosDataSet.usuariosDataTable GetDataByIDUsuario(int IDUsuario) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(IDUsuario));
            UsuariosDataSet.usuariosDataTable dataTable = new UsuariosDataSet.usuariosDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual int Delete(int Original_IDUsuario, string Original_nombre, string Original_password, int Original_IDRole, bool Original_activo) {
        ...
        public virtual int Insert(string nombre, string password, int IDRole, bool activo) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string password, int IDRole, bool activo, int Original_IDUsuario, string Original_nombre, string Original_password, int Original_IDRole, bool Original_activo, int IDUsuario) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string password, int IDRole, bool activo, int Original_IDUsuario, string Original_nombre, string Original_password, int Original_IDRole, bool Original_activo) {
            return this.Update(nombre, password, IDRole, activo, Original_IDUsuario, Original_nombre, Original_password, Original_IDRole, Original_activo, Original_IDUsuario);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> TienePermiso(int IDUsuario, int IDPermiso) {
